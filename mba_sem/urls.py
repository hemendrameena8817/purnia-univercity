...
urlpatterns = [
    ...
    path('mba/tr/', MBAResultSheetPDFView.as_view(), name="mba-result-sheet-pdf"),
    path('mba/tr/result-declaration/pdf/', MBAResultDeclarationPDFView.as_view(), name="mba-result-declaration-pdf"),
